...
public class ManageCreatures extends AppCompatActivity {
    private DataManager db;
    private ListView lv;
    private ArrayList<Creature> temp;
    ...
    public void launchEditActivity(View view) {//launches add/edit Creature activity
        Intent intent = new Intent(this,EditCreature.class);
        intent.putExtra("Creature",tar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {//toolbar menu options
        ...
        inflater.inflate(R.menu.app_bar_menu_creature,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {//toolbar menu listeners
        ...
        switch (item.getItemId()){
            case R.id.About:
                ...
                startActivity(intent);
                break;
            case R.id.Add_Creature:
                intent = new Intent(this,EditCreature.class);
                startActivity(intent);
                break;
        }
